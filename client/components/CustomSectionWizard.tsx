...
const SECTION_TEMPLATES = [
  {
    ...
    fields: [
      { label: 'Certificate Name', type: 'text' as FieldType, required: true },
      { label: 'Issuing Organization', type: 'text' as FieldType, required: true },
      { label: 'Issue Date', type: 'date' as FieldType, required: false },
      { label: 'Expiry Date', type: 'date' as FieldType, required: false },
      { label: 'Certificate URL', type: 'url' as FieldType, required: false },
    ],
  },
  {
    name: 'Languages',
    ...
    fields: [
      { label: 'Language', type: 'text' as FieldType, required: true },
      { label: 'Proficiency Level', type: 'rating' as FieldType, required: true, maxRating: 5 },
    ],
  },
  {
    name: 'Volunteer Work',
    ...
    fields: [
      { label: 'Organization', type: 'text' as FieldType, required: true },
      { label: 'Role', type: 'text' as FieldType, required: true },
      { label: 'Start Date', type: 'date' as FieldType, required: true },
      { label: 'End Date', type: 'date' as FieldType, required: false },
      { label: 'Description', type: 'bullets' as FieldType, required: false },
    ],
  },
  {
    name: 'Awards',
    ...
    layout: 'single-column' as const,
    fields: [
      { label: 'Award Title', type: 'text' as FieldType, required: true },
      { label: 'Awarding Organization', type: 'text' as FieldType, required: true },
      { label: 'Date Received', type: 'date' as FieldType, required: true },
      { label: 'Description', type: 'textarea' as FieldType, required: false },
    ],
  },
  {
    name: 'Publications',
    ...
    layout: 'single-column' as const,
    fields: [
      { label: 'Title', type: 'text' as FieldType, required: true },
      { label: 'Publication Venue', type: 'text' as FieldType, required: true },
      { label: 'Publication Date', type: 'date' as FieldType, required: true },
      { label: 'URL/DOI', type: 'url' as FieldType, required: false },
      { label: 'Abstract', type: 'textarea' as FieldType, required: false },
    ],
  },
  {
    name: 'References',
    ...
    layout: 'two-column' as const,
    fields: [
      { label: 'Reference Name', type: 'text' as FieldType, required: true },
      { label: 'Job Title', type: 'text' as FieldType, required: true },
      { label: 'Company', type: 'text' as FieldType, required: true },
      { label: 'Email', type: 'email' as FieldType, required: false },
      { label: 'Phone', type: 'phone' as FieldType, required: false },
    ],
  },
];
...
interface SortableFieldProps {
  field: CustomField;
  index: number;
  onUpdate: (index: number, field: CustomField) => void;
  onRemove: (index: number) => void;
}

function SortableField({ field, index, onUpdate, onRemove }: SortableFieldProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
...
export default function CustomSectionWizard({
  ...
  const [layout, setLayout] = useState<CustomSection['layout']>('single-column');
  ...
  const useTemplate = (template: typeof SECTION_TEMPLATES[0]) => {
